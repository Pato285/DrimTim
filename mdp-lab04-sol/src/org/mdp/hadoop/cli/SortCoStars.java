...
public class SortCoStars {
	...
	public static class SortCoStarsMapper extends 
		...
		public void map(Object key, Text value, Context output)
			...
			output.write(new DescendingIntWritable(Integer.parseInt(split[2])),new Text(split[0]+"\t"+split[1]));
		}
	}
	...
	public static void main(String[] args) throws Exception {
		...
		if (otherArgs.length != 2) {
			System.err.println("Usage: "+SortCoStars.class.getName()+" <in> <out>");
			System.exit(2);
		}
		...
		job.setJarByClass(SortCoStars.class);
